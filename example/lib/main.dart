...
import 'package:ads/test_ad_id_manager.dart';
...
class _CountryListScreenState extends State<CountryListScreen> {
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              EasyBannerAd(adId: adIdManager.admobAdIds!.bannerId!),
            ],
          ),
        ),
      ),
  ...
  Future<void> _showAd(AdNetwork adNetwork, AdUnitType adUnitType) async {
    if (await EasyAds.instance.showAd(adUnitType)) {
  ...
  Future<void> _showAvailableAd(AdUnitType adUnitType) async {
    if (await EasyAds.instance.showAd(adUnitType)) {
      // Canceling the last callback subscribed
      _streamSubscription?.cancel();
      // Listening to the callback from showRewardedAd()
